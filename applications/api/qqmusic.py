...
def fetch_data():
    ...
    if file_content is None:
        ...
        xpath_artist = '//*[@id="app"]/div/div[2]/div[2]/div[3]/ul[2]/li/div/div[4]/a/@title'
        ...
        articles_artist = tree.xpath(xpath_artist)
        ...
        for title, artist in zip(articles_title, articles_artist):
            combined_title = f"{title} - {artist}"
            combined_titles.append(combined_title)

        datas = [combined_titles, articles_url, articles_hot]
